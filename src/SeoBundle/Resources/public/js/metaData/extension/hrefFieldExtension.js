pimcore.registerNS('Seo.MetaData.Extension.HrefFieldExtension');
Seo.MetaData.Extension.HrefFieldExtension = Class.create({
    ...
    generateElement: function () {
        ...
        this.href = Ext.create('Seo.HrefTextField', options);
    ...
    generateFieldName(name) {
        return this.locale === null ? name : name + '.' + this.locale;
    }
